    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=11, primary_key=True, serialize=False, validators=[django.core.validators.RegexValidator('^01([0|1|6|7|8|9]?)-?([0-9]{3,4})-?([0-9]{4})$')], verbose_name='휴대폰 번호')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('species', models.CharField(choices=[(None, '선택'), ('dog', '강아지'), ('cat', '고양이')], default='선택', max_length=3)),
