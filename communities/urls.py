...
urlpatterns = [
    ...
    # comment
    path("<int:community_pk>/comment/create/", views.comment_create, name="comment_create"),
    path("<int:community_pk>/comment/<int:comment_pk>/delete/", views.comment_delete, name="comment_delete"),
]